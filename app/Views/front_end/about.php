      ...
      <div class="row">
        <div class="col-md-4">
          <p style="font-size: 18px; line-height: 26px">
            Who loves or pursues or desires to <b>DESIGN</b> pain of itself,but
            because and occasionally circumstances occur pain can procure him
            some great easure of the past.
          </p>
        </div>
        <div class="col-md-4">
          <p>
            THE CREATIVE qui dolorem ipsum quia dolor sit amet, consectetur,
            adipisci velit, sed quia non numquam eius modi tempora incidunt ut
            labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad
            minima quis nostrum exercitationem ullam corporis suscipit aliquid.
          </p>
        </div>
        <div class="col-md-4">
          <p>
            <strong>WEB DESIGN</strong> qui dolorem ipsum quia dolor sit amet,
            MINIMALISM adipisci velit, sed quia non numquam eius modi tempora
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          >
            <div class="col-md-6 col-md-offset-6">
              <div
                class="our-story-content wow fadeInUp"
                data-wow-duration="0.5s"
                data-wow-delay="0.5s"
              >
                <div class="our-story-content-inner">
                  ...
                  <p>
                    ...
                    consequences that are extremely painful. <br /><br />
              ...
              <div class="overlay-member-content">
                <div class="overlay-member-content-inner">
                  ...
                  <ul class="member-social-media">
                    <li>
                      <a href="http://facebook.com/EliteFingers" target="_blank"
                        >Facebook</a
                      >
                    </li>
                    <li>
                      <a href="http://twitter.com/EliteFingers" target="_blank"
                        >Twitter</a
                      >
                    </li>
    ...
    <div class="container margin-top">
      <div class="clients-wrapper">
        <ul class="client-thumb">
          ...
          <li>
            <a href="#"
              ><img src="img/clients/client_2.jpg" alt="Client 1"
            /></a>
          </li>
          <li>
            <a href="#"
              ><img src="img/clients/client_3.jpg" alt="Client 1"
            /></a>
          </li>
          <li>
            <a href="#"
              ><img src="img/clients/client_4.jpg" alt="Client 1"
            /></a>
          </li>
        </ul>
      </div>

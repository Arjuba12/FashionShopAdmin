    ...
    <div class="slider-container" >
      ...
      <div class="slider">
        <div class="slide slide-0 active">
          <div
            class="slide__bg"
            style="background-image: url('img/full-slider/image_1.jpg')"
          ></div>
        ...
        <div class="slide slide-1">
          <div
            class="slide__bg"
            style="background-image: url('img/full-slider/image_2.jpg')"
          ></div>
          <div class="slide__content">
            <svg
              class="slide__overlay"
        ...
        <div class="slide slide-2">
          <div
            class="slide__bg"
            style="background-image: url('img/full-slider/image_3.jpg')"
          ></div>
          <div class="slide__content">
            <svg
              class="slide__overlay"
